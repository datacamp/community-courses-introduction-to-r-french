...
Pas mal pour un débutant de R, n'est-ce pas ? ;-)
...
test_object("shining_list",
            undefined_msg = "Faites attention à bien avoir défini la variable <code>shining_list</code>.",
...
acteurs      <- c("Jack Nicholson","Shelley Duvall","Danny Lloyd","Scatman Crothers","Barry Nelson")
sources     <- c("IMDb1","IMDb2","IMDb3")
commentaires    <-c ("Meilleur Film d'horreur que j'ai jamais vu", "Un film vraiment génial et effrayant de Stanley Kubrick", "Un chef-d'oeuvre de scores      <- c(4.5,4,5)
avis     <- data.frame(scores,sources,commentaires)
shining_list <- list(titre="Shining",acteurs=acteurs, avis=avis)
```
...
*** =instructions
- Complétez le code ci-dessous pour qu'un élément nommé `année` soit ajouté à `shining_list` avec la valeur 1980. Affectez le résultat à `shining_list_full`.
...
# Nous avons oublié quelque chose, rajoutez l'année à shining_list:
shining_list_full <- c(shining_list, année = 1980)
