...
Plusieurs graphiques ont été générés, vous pouvez naviguer de l'un à l'autre via les boutons "previous plot" et "next plot". Cette fenêtre se fermera à la prochaine étape.
