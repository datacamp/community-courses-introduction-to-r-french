...
--- type:NormalExercise xp:100 key:af29a21e03
...
--- type:NormalExercise xp:100 key:86cde1ae9d
...
--- type:NormalExercise xp:100 key:d19129aa10
...
--- type:NormalExercise xp:100 key:1b80277618
...
--- type:NormalExercise xp:100 key:fe43d390e6
...
success_msg("Très bien ! Le grand avantage de faire des calculs avec les variables est que vous pouvez les réutiliser. Si vous modifiez simplement <code>mes_pommes</code> en changeant la valeur à 12 au lieu de 5 et que vous exécutez de nouveau le script (et seulement si vous l'éxecutez à nouveau), la valeur de <code>mes_fruits</code> sera automatiquement mise à jour. On passe à l'exercice suivant.")
```

*** =skills
1

--- type:NormalExercise xp:100 key:130f3d0b0a
...
*** =hint
Vous devez affecter la valeur numérique `6` à la variable `mes_oranges` au lieu de la chaîne de caractère `"six"`. Notez comment les guillemets servent à indiquer que `"six"` est une chaîne de caractère.
...
--- type:NormalExercise xp:100 key:1eb537ab4e
...
--- type:NormalExercise xp:100 key:e8e384850c
