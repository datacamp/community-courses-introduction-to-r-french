...
*** =instructions
Construire une matrice avec 3 lignes contenant les chiffres 1 à 9. Cliquez sur le bouton `Envoyer réponse` et regardez la sortie dans la console.
*** =hint
...
Construire une matrice avec une ligne pour chaque film (donc 3 lignes). La première colonne est pour les recettes du Box-Office américain et la deuxième colonne pour les recettes de billetterie non-américaine. Nommez la matrice `star_wars_matrix`.
...
test_object("star_wars_matrix",
            undefined_msg = "Faites attention à bien avoir défini la variable <code>star_wars_matrix</code>.",
...
*** =instructions
- Donnez aux colonnes de `star_wars_matrix` les noms `"Américain"` et `"non-Américain"`.
...
colnames(star_wars_matrix) <- c("Américain", "non-Américain")
...
test_object("star_wars_matrix",
            ...
            incorrect_msg = "Avez-vous bien fabriqué la bonne matrice, elle doit contenir les 3 vecteurs relatifs aux 3 films et se nommer  à <code>star_wars_matrix</code>?")
...
titre_colonnes <- c("Américain","non-Américain")
...
# Collez la nouvelle mondial_vector variable en tant que colonne dans star_wars_matrix
...
noms_films2 <- c("La Menace fantôme", "L'Attaque des clones", "La Revanche des Sith")
...
-Même question, mais maintenant que pour les deux premiers films de Star Wars. Affectez le résultat à `non_us_partiel`.
...
test_object("non_us_partiel",
            undefined_msg = "Faites attention à bien avoir défini la variable <code>non_us_partiel</code>.",
...
Tout commence avec que vous avez appris  sur les vecteurs, les opérateurs standard `+`, `-`, `/`, `*`, etc. Ils fonctionnent termes à termes avec les matrices dans R. 
...
En tant que statisticien nouvellement engagé pour Lucasfilm, c'est votre job de savoir combien de visiteurs sont allés à chaque film pour chaque zone géographique. Vous avez déjà les chiffres de revenus totaux en `star_wars_matrix`. Supposons que le prix d'un billet était de 5 dollars. Les montants de billetterie, divisés par le prix du billet, vous donnent le nombre de visiteurs.
...
*** =instructions
-Fabriquer la matrice `visiteur` avec le nombre estimé de visiteurs non-Américain et de visiteurs américain pour les trois films.
...
test_object("visiteurs",
            undefined_msg = "Faites attention à bien avoir défini la variable <code>visiteurs</code>.",
...
Ceux qui sont familiers des matrices doivent noter qu'il ne s'agit pas ici de multiplication matricielle standard... pour celle-là vous devez utiliser `%*%' dans R. _




*** =instructions
-Assignez à `visiteurs` la matrice avec votre nombre estimé de visiteurs non-Américain et Américain pour les trois films.
