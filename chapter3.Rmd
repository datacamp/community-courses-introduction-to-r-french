...
*** =instructions
- Donnez aux colonnes de `star_wars_matrix` les noms `"Americain"` et `"non-Americain"`.
...
*** =instructions
- Fabriquez la matrice `visiteur` avec le nombre estimé de visiteurs non-Américain et de visiteurs américain pour les trois films.
